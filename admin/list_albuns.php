            ...
            if (isset($_GET['resp'])) {
                ...
                if ($_GET['resp'] == "sucesso") {
                    ...
                    <div class="alert alert-success fade in">
                        ...
                        <strong>SUCESSO!</strong> Album cadastrado com sucesso!
                    </div>
                    <?php
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        <strong>ERRO!</strong> Ocorreu um erro ao cadastrar o Album
                    </div>
                    <?php
                }
            }
            ...
            if (isset($_GET['respe'])) {
                ...
                if ($_GET['respe'] == "sucesso") {
                    ...
                    <div class="alert alert-success fade in">
                        ...
                        <strong>SUCESSO!</strong> Album alterado com sucesso!
                    </div>
                    <?php
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        <strong>ERRO!</strong> Ocorreu um erro ao alterar o Album
                    </div>
                    <?php
                }
            }
            ...
            if (isset($_GET['respt'])) {
                ...
                if ($_GET['respt'] == "sucesso") {
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        <strong>ERRO!</strong> Ocorreu um erro ao excluir o Album
                    </div>
                    <?php
                }
            }
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="php/exclui_album.php?id=<?php echo $array_dados['album_id']; ?>"><button class="btn btn-warning" type="button"> Confirmar</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
