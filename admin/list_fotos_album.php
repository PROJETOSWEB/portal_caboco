...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            ...
            <?php
            $id = $_GET['id'];
            $sql_album = "SELECT * FROM album WHERE album_id = $id";
            $executa_album = mysql_query($sql_album)or die(mysql_error());
            $dados_album = mysql_fetch_array($executa_album);
            ?>

            <h1 style="font-weight: 300;"><span class="fa fa-video-camera"></span> ÁLBUM: <?php echo $dados_album['nome'] ?></h1>
            ...
            if (isset($_GET['respt'])) {
                ...
                if ($_GET['respt'] == "sucesso") {
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        <strong>ERRO!</strong> Ocorreu um erro ao excluir a Foto
                    </div>
                    <?php
                }
            }
                            ...
                            <div class="adv-table">
                                <table  class="display table table-bordered table-striped" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        $seleciona_dados = "SELECT * FROM album_fotos
                                                            INNER JOIN album ON album.album_id = album_fotos.album_id
                                                            INNER JOIN usuario ON album.usuario_id = usuario.usuario_id
                                                            WHERE album_fotos.album_id = $id_album";
                                        ...
                                        while ($array_dados = mysql_fetch_array($executa_seleciona_dados)) {
                                            ...
                                            <tr class="gradeA" style="text-align: center; vertical-align: center;">
                                                <td style="text-align: left;">
                                                    <a class="fancybox" rel="id_foto" href="imagens/fotos/<?php echo $array_dados['img']; ?>" title="<?php echo $array_dados['legenda'] ?>">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="php/exclui_fotos.php?id=<?php echo $array_dados['album_fotos_id']; ?>&album=<?php echo $_GET['id']; ?>"><button class="btn btn-warning" type="button"> Confirmar</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
