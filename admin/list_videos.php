            ...
            if (isset($_GET['resp'])) {
                ...
                if ($_GET['resp'] == "sucesso") {
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        <strong>ERRO!</strong> Ocorreu um erro ao cadastrar o Vídeo
                    </div>
                    <?php
                }
            }
            ...
            if (isset($_GET['respe'])) {
                ...
                if ($_GET['respe'] == "sucesso") {
                    ...
                    <div class="alert alert-success fade in">
                        ...
                        <strong>SUCESSO!</strong> Vídeo alterado com sucesso!
                    </div>
                    <?php
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        <strong>ERRO!</strong> Ocorreu um erro ao alterar o Vídeo
                    </div>
                    <?php
                }
            }
            ...
            if (isset($_GET['respt'])) {
                ...
                if ($_GET['respt'] == "sucesso") {
                    ...
                    <div class="alert alert-danger fade in">
                        ...
                        <strong>ERRO!</strong> Ocorreu um erro ao excluir o Vídeo
                    </div>
                    <?php
                }
            }
                            ...
                            <div class="adv-table">
                                <table  class="display table table-bordered table-striped" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $seleciona_dados = "SELECT * FROM videos INNER JOIN usuario ON "
                                                . "videos.usuario_id = usuario.usuario_id ORDER BY videos_id DESC";
                                        ...
                                        while ($array_dados = mysql_fetch_array($executa_seleciona_dados)) {
                                            ...
                                            <tr class="gradeA" style="text-align: center; vertical-align: center;">
                                                <td style="text-align: left;">
                                                    <iframe width="150" height="100" src="https://www.youtube.com/embed/<?php echo $array_dados['codigo'] ?>?wmode=transparent" allowfullscreen></iframe>
                                                </td>
