...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Out-2015 às 00:11
...
CREATE TABLE IF NOT EXISTS `album_fotos` (
  ...
  KEY `fk_album_fotos_album1_idx` (`album_id`)
...
CREATE TABLE IF NOT EXISTS `banner` (
  ...
  KEY `fk_banner_usuario1_idx` (`usuario_id`)
...
(3, '2015-10-26', '2015-10-27', 'SUPER BANNER - HOME', 'banner Meio Norte', 'http://www.carangoavapor.com', 'construmetal-2016-super-banner-728x90.gif', 2, 1),
(4, '2015-10-14', '2015-10-30', 'RODAPÉ BANNER - HOME', 'Karoline', 'http://www.carangoavapor.com', 'banner-topo.gif', 2, 1),
...
CREATE TABLE IF NOT EXISTS `blogs` (
  ...
  KEY `fk_blogs_usuario1_idx` (`usuario_id`)
...
CREATE TABLE IF NOT EXISTS `noticia` (
  ...
  KEY `fk_noticia_sub_editoriais1_idx` (`sub_editoriais_id`),
...
CREATE TABLE IF NOT EXISTS `sub_editoriais` (
  `sub_editoriais_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `editoria_id` int(10) unsigned NOT NULL,
  `sub_editora` varchar(100) NOT NULL DEFAULT '',
  `usuario_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`sub_editoriais_id`),
  KEY `fk_sub_editoriais_usuario1_idx` (`usuario_id`),
  KEY `fk_sub_editoriais_editoria1_idx` (`editoria_id`)
...
CREATE TABLE IF NOT EXISTS `videos` (
  ...
  KEY `fk_videos_usuario1_idx` (`usuario_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;
