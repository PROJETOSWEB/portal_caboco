                            ...
                            <div class="ot-panel-block">
                                ...
                                <div class="pagination">
                                    ...
                                    if (isset($_GET['page'])) {
                                        ...
                                        if ($_GET['page'] == $pags) {
                                            ?>
                                            <a class="next page-numbers" href="list_mais_lidas.php?page=<?php echo $pags ?>">próxima<i class="fa fa-caret-right"></i></a>

                                            <?php
                                        } else {
                                            ?>
                                            <a class="next page-numbers" href="list_mais_lidas.php?page=<?php echo $p + 1; ?>">próxima<i class="fa fa-caret-right"></i></a>

                                            <?php
                                        }
                                    } else {
                                        ?>
                                        <a class="next page-numbers" href="list_noticias_editorias.php?page=<?php echo $pags; ?>">próxima<i class="fa fa-caret-right"></i></a>
